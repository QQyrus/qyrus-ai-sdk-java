...
public class AsyncDataAmplifier {

    private final String apiKey;
    private String baseUrl;
    private String gatewayToken;
    
    public AsyncDataAmplifier(String apiKey, String baseUrl) {
        this.apiKey = apiKey;
        try {
            // Verifying the token
    ...
    public CompletableFuture<DataAmplifierResponse> create(List<Map<String, Object>> example_data, int data_count) {
