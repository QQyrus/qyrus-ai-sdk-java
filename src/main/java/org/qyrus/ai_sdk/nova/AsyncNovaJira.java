...
public class AsyncNovaJira {
    private final String apiKey;
    private String baseUrl;
    private String gatewayToken;
    
    public AsyncNovaJira(String apiKey, String baseUrl) {
        this.apiKey = apiKey;
        try {
            // Verifying the token
    ...
    public CompletableFuture<CreateScenariosResponse> create(String jiraEndpoint, String jiraApiToken, String jiraUsername, String jiraId) {
